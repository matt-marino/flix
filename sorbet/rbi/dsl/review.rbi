...
class Review
  ...
  module CommonRelationMethods
    ...
    sig { params(block: T.nilable(T.proc.params(object: ::Review).void)).returns(::Review) }
    sig do
      params(
    ...
    sig { params(column_name: NilClass, block: T.proc.params(object: ::Review).void).returns(Integer) }
    ...
    sig do
      ...
      ).returns(T::Enumerable[::Review])
    end
    sig { params(args: NilClass, block: T.proc.params(object: ::Review).void).returns(T.nilable(::Review)) }
    ...
    sig do
      params(
        ...
        order: Symbol,
        block: T.proc.params(object: ::Review).void
      ).void
    end
    sig do
      params(
    ...
    sig do
      params(
        ...
        error_on_ignore: T.untyped,
        order: Symbol,
        block: T.proc.params(object: T::Array[::Review]).void
      ).void
    end
    sig do
      params(
        ...
        error_on_ignore: T.untyped,
        order: Symbol
      ).returns(T::Enumerator[T::Enumerator[::Review]])
    end
    ...
    sig do
      type_parameters(:U)
        .params(
          ...
          block: T.proc.params(object: ::Review).returns(T.type_parameter(:U))
  ...
  module GeneratedAssociationRelationMethods
    ...
    sig { params(blk: T.proc.params(record: ::Review).returns(BasicObject)).returns(T::Array[::Review]) }
