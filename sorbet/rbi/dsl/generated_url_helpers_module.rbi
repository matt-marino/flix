...
module GeneratedUrlHelpersModule
  ...
  sig { params(args: T.untyped).returns(String) }
  def edit_movie_review_url(*args); end

  sig { params(args: T.untyped).returns(String) }
  def edit_movie_url(*args); end

  sig { params(args: T.untyped).returns(String) }
  def edit_user_url(*args); end

  sig { params(args: T.untyped).returns(String) }
  def filtered_movies_url(*args); end
  ...
  sig { params(args: T.untyped).returns(String) }
  def movie_favorite_url(*args); end

  sig { params(args: T.untyped).returns(String) }
  def movie_favorites_url(*args); end

  sig { params(args: T.untyped).returns(String) }
  def movie_review_url(*args); end

  sig { params(args: T.untyped).returns(String) }
  def movie_reviews_url(*args); end

  sig { params(args: T.untyped).returns(String) }
  def movie_url(*args); end

  sig { params(args: T.untyped).returns(String) }
  def movies_url(*args); end

  sig { params(args: T.untyped).returns(String) }
  def new_genre_url(*args); end

  sig { params(args: T.untyped).returns(String) }
  def new_movie_review_url(*args); end

  sig { params(args: T.untyped).returns(String) }
  def new_movie_url(*args); end
