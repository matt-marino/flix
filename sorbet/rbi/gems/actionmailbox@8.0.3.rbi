...
module ActionMailbox
  ...
  class << self
    ...
    # source://railties/8.0.3/lib/rails/engine.rb#413
    def railtie_helpers_paths; end

    # source://railties/8.0.3/lib/rails/engine.rb#396
    def railtie_namespace; end

    # source://railties/8.0.3/lib/rails/engine.rb#417
    ...
    # source://railties/8.0.3/lib/rails/engine.rb#402
    def table_name_prefix; end

    # source://railties/8.0.3/lib/rails/engine.rb#409
...
class ActionMailbox::Base
  ...
  # source://activesupport/8.0.3/lib/active_support/callbacks.rb#69
  def __callbacks; end

  # source://activesupport/8.0.3/lib/active_support/callbacks.rb#924
  def _process_callbacks; end

  # source://activesupport/8.0.3/lib/active_support/callbacks.rb#912
  ...
  # source://activesupport/8.0.3/lib/active_support/rescuable.rb#15
  ...
  class << self
    ...
    # source://activesupport/8.0.3/lib/active_support/callbacks.rb#916
    def _process_callbacks; end

    # source://activesupport/8.0.3/lib/active_support/callbacks.rb#920
    ...
    # source://activesupport/8.0.3/lib/active_support/class_attribute.rb#15
    def __class_attr___callbacks; end

    # source://activesupport/8.0.3/lib/active_support/class_attribute.rb#17
...
class ActionMailbox::BaseController < ::ActionController::Base
  ...
  # source://actionview/8.0.3/lib/action_view/layouts.rb#328
...
class ActionMailbox::InboundEmail < ::ActionMailbox::Record
  ...
  # source://activerecord/8.0.3/lib/active_record/autosave_association.rb#162
  ...
  class << self
    # source://activerecord/8.0.3/lib/active_record/scoping/named.rb#174
    ...
    # source://activerecord/8.0.3/lib/active_record/enum.rb#233
    def statuses; end
...
module ActionMailbox::InboundEmail::GeneratedAssociationMethods
  # source://activerecord/8.0.3/lib/active_record/associations/builder/singular_association.rb#32
  def build_raw_email_attachment(*args, &block); end

  # source://activerecord/8.0.3/lib/active_record/associations/builder/singular_association.rb#32
  def build_raw_email_blob(*args, &block); end

  # source://activerecord/8.0.3/lib/active_record/associations/builder/singular_association.rb#36
  def create_raw_email_attachment(*args, &block); end

  # source://activerecord/8.0.3/lib/active_record/associations/builder/singular_association.rb#40
  def create_raw_email_attachment!(*args, &block); end
  ...
  # source://activestorage/8.0.3/lib/active_storage/attached/model.rb#113
  def raw_email; end

  # source://activestorage/8.0.3/lib/active_storage/attached/model.rb#118
  def raw_email=(attachable); end

  # source://activerecord/8.0.3/lib/active_record/associations/builder/association.rb#104
  def raw_email_attachment; end

  # source://activerecord/8.0.3/lib/active_record/associations/builder/association.rb#112
  ...
  # source://activerecord/8.0.3/lib/active_record/associations/builder/singular_association.rb#19
  def reload_raw_email_attachment; end

  # source://activerecord/8.0.3/lib/active_record/associations/builder/singular_association.rb#19
  def reload_raw_email_blob; end

  # source://activerecord/8.0.3/lib/active_record/associations/builder/singular_association.rb#23
...
module Mail
  class << self
    # source://mail/2.9.0/lib/mail/mail.rb#163
    def all(*args, &block); end

    # source://mail/2.9.0/lib/mail/mail.rb#183
    def connection(&block); end

    # source://mail/2.9.0/lib/mail/mail.rb#98
    def defaults(&block); end

    # source://mail/2.9.0/lib/mail/mail.rb#174
    def delete_all(*args, &block); end

    # source://mail/2.9.0/lib/mail/mail.rb#131
    def deliver(*args, &block); end

    # source://mail/2.9.0/lib/mail/mail.rb#240
    def delivery_interceptors; end

    # source://mail/2.9.0/lib/mail/mail.rb#103
    def delivery_method; end

    # source://mail/2.9.0/lib/mail.rb#35
    def eager_autoload!; end

    # source://mail/2.9.0/lib/mail/mail.rb#139
    def find(*args, &block); end

    # source://mail/2.9.0/lib/mail/mail.rb#145
    def find_and_delete(*args, &block); end

    # source://mail/2.9.0/lib/mail/mail.rb#151
    def first(*args, &block); end

    # source://actionmailbox//lib/action_mailbox/mail_ext/from_source.rb#4
    def from_source(source); end

    # source://mail/2.9.0/lib/mail/mail.rb#233
    def inform_interceptors(mail); end

    # source://mail/2.9.0/lib/mail/mail.rb#227
    def inform_observers(mail); end

    # source://mail/2.9.0/lib/mail/mail.rb#157
    def last(*args, &block); end

    # source://mail/2.9.0/lib/mail/mail.rb#50
    def new(*args, &block); end

    # source://mail/2.9.0/lib/mail/mail.rb#248
    def random_tag; end

    # source://mail/2.9.0/lib/mail/mail.rb#168
    def read(filename); end

    # source://mail/2.9.0/lib/mail/mail.rb#179
    def read_from_string(mail_as_string); end

    # source://mail/2.9.0/lib/mail.rb#23
    def register_autoload(name, path); end

    # source://mail/2.9.0/lib/mail/mail.rb#215
    def register_interceptor(interceptor); end

    # source://mail/2.9.0/lib/mail/mail.rb#196
    def register_observer(observer); end

    # source://mail/2.9.0/lib/mail/mail.rb#108
    def retriever_method; end

    # source://mail/2.9.0/lib/mail/mail.rb#257
    def something_random; end

    # source://mail/2.9.0/lib/mail/mail.rb#261
    def uniq; end

    # source://mail/2.9.0/lib/mail/mail.rb#223
    def unregister_interceptor(interceptor); end

    # source://mail/2.9.0/lib/mail/mail.rb#204
...
class Mail::Address
  # source://mail/2.9.0/lib/mail/elements/address.rb#25
  def initialize(value = T.unsafe(nil)); end

  # source://actionmailbox//lib/action_mailbox/mail_ext/address_equality.rb#5
  def ==(other_address); end

  # source://mail/2.9.0/lib/mail/elements/address.rb#65
  def address(output_type = T.unsafe(nil)); end

  # source://mail/2.9.0/lib/mail/elements/address.rb#79
  def address=(value); end

  # source://mail/2.9.0/lib/mail/elements/address.rb#132
  def comments; end

  # source://mail/2.9.0/lib/mail/elements/address.rb#173
  def decoded; end

  # source://mail/2.9.0/lib/mail/elements/address.rb#87
  def display_name(output_type = T.unsafe(nil)); end

  # source://mail/2.9.0/lib/mail/elements/address.rb#99
  def display_name=(str); end

  # source://mail/2.9.0/lib/mail/elements/address.rb#118
  def domain(output_type = T.unsafe(nil)); end

  # source://mail/2.9.0/lib/mail/elements/address.rb#169
  def encoded; end

  # source://mail/2.9.0/lib/mail/elements/address.rb#47
  def format(output_type = T.unsafe(nil)); end

  # source://mail/2.9.0/lib/mail/elements/address.rb#177
  def group; end

  # source://mail/2.9.0/lib/mail/elements/address.rb#164
  def inspect; end

  # source://mail/2.9.0/lib/mail/elements/address.rb#108
  def local(output_type = T.unsafe(nil)); end

  # source://mail/2.9.0/lib/mail/elements/address.rb#147
  def name; end

  # source://mail/2.9.0/lib/mail/elements/address.rb#36
  def raw; end

  # source://mail/2.9.0/lib/mail/elements/address.rb#156
  def to_s; end

  private

  # source://mail/2.9.0/lib/mail/elements/address.rb#237
  def format_comments; end

  # source://mail/2.9.0/lib/mail/elements/address.rb#254
  def get_comments; end

  # source://mail/2.9.0/lib/mail/elements/address.rb#218
  def get_display_name; end

  # source://mail/2.9.0/lib/mail/elements/address.rb#250
  def get_domain; end

  # source://mail/2.9.0/lib/mail/elements/address.rb#246
  def get_local; end

  # source://mail/2.9.0/lib/mail/elements/address.rb#227
  def get_name; end

  # source://mail/2.9.0/lib/mail/elements/address.rb#183
  def parse(value = T.unsafe(nil)); end

  # source://mail/2.9.0/lib/mail/elements/address.rb#198
  def strip_all_comments(string); end

  # source://mail/2.9.0/lib/mail/elements/address.rb#207
...
class Mail::Message
  # source://mail/2.9.0/lib/mail/message.rb#107
  def initialize(*args, &block); end

  # source://mail/2.9.0/lib/mail/message.rb#334
  def <=>(other); end

  # source://mail/2.9.0/lib/mail/message.rb#377
  def ==(other); end

  # source://mail/2.9.0/lib/mail/message.rb#1341
  def [](name); end

  # source://mail/2.9.0/lib/mail/message.rb#1323
  def []=(name, value); end

  # source://mail/2.9.0/lib/mail/message.rb#1565
  def action; end

  # source://mail/2.9.0/lib/mail/message.rb#1479
  def add_charset; end

  # source://mail/2.9.0/lib/mail/message.rb#1494
  def add_content_transfer_encoding; end

  # source://mail/2.9.0/lib/mail/message.rb#1472
  def add_content_type; end

  # source://mail/2.9.0/lib/mail/message.rb#1455
  def add_date(date_val = T.unsafe(nil)); end

  # source://mail/2.9.0/lib/mail/message.rb#1764
  def add_file(values); end

  # source://mail/2.9.0/lib/mail/message.rb#1445
  def add_message_id(msg_id_val = T.unsafe(nil)); end

  # source://mail/2.9.0/lib/mail/message.rb#1465
  def add_mime_version(ver_val = T.unsafe(nil)); end

  # source://mail/2.9.0/lib/mail/message.rb#1708
  def add_part(part); end

  # source://mail/2.9.0/lib/mail/message.rb#1934
  def all_parts; end

  # source://mail/2.9.0/lib/mail/message.rb#1925
  def attachment; end

  # source://mail/2.9.0/lib/mail/message.rb#1920
  def attachment?; end

  # source://mail/2.9.0/lib/mail/message.rb#1633
  def attachments; end

  # source://mail/2.9.0/lib/mail/message.rb#507
  def bcc(val = T.unsafe(nil)); end

  # source://mail/2.9.0/lib/mail/message.rb#519
  def bcc=(val); end

  # source://actionmailbox//lib/action_mailbox/mail_ext/addresses.rb#21
  def bcc_addresses; end

  # source://mail/2.9.0/lib/mail/message.rb#1313
  def bcc_addrs; end

  # source://mail/2.9.0/lib/mail/message.rb#1258
  def body(value = T.unsafe(nil)); end

  # source://mail/2.9.0/lib/mail/message.rb#1244
  def body=(value); end

  # source://mail/2.9.0/lib/mail/message.rb#1267
  def body_encoding(value = T.unsafe(nil)); end

  # source://mail/2.9.0/lib/mail/message.rb#1275
  def body_encoding=(value); end

  # source://mail/2.9.0/lib/mail/message.rb#1561
  def bounced?; end

  # source://mail/2.9.0/lib/mail/message.rb#1590
  def boundary; end

  # source://mail/2.9.0/lib/mail/message.rb#548
  def cc(val = T.unsafe(nil)); end

  # source://mail/2.9.0/lib/mail/message.rb#560
  def cc=(val); end

  # source://actionmailbox//lib/action_mailbox/mail_ext/addresses.rb#17
  def cc_addresses; end

  # source://mail/2.9.0/lib/mail/message.rb#1307
  def cc_addrs; end

  # source://mail/2.9.0/lib/mail/message.rb#1504
  def charset; end

  # source://mail/2.9.0/lib/mail/message.rb#1513
  def charset=(value); end

  # source://mail/2.9.0/lib/mail/message.rb#564
  def comments(val = T.unsafe(nil)); end

  # source://mail/2.9.0/lib/mail/message.rb#568
  def comments=(val); end

  # source://mail/2.9.0/lib/mail/message.rb#572
  def content_description(val = T.unsafe(nil)); end

  # source://mail/2.9.0/lib/mail/message.rb#576
  def content_description=(val); end

  # source://mail/2.9.0/lib/mail/message.rb#580
  def content_disposition(val = T.unsafe(nil)); end

  # source://mail/2.9.0/lib/mail/message.rb#584
  def content_disposition=(val); end

  # source://mail/2.9.0/lib/mail/message.rb#588
  def content_id(val = T.unsafe(nil)); end

  # source://mail/2.9.0/lib/mail/message.rb#592
  def content_id=(val); end

  # source://mail/2.9.0/lib/mail/message.rb#596
  def content_location(val = T.unsafe(nil)); end

  # source://mail/2.9.0/lib/mail/message.rb#600
  def content_location=(val); end

  # source://mail/2.9.0/lib/mail/message.rb#604
  def content_transfer_encoding(val = T.unsafe(nil)); end

  # source://mail/2.9.0/lib/mail/message.rb#608
  def content_transfer_encoding=(val); end

  # source://mail/2.9.0/lib/mail/message.rb#612
  def content_type(val = T.unsafe(nil)); end

  # source://mail/2.9.0/lib/mail/message.rb#616
  def content_type=(val); end

  # source://mail/2.9.0/lib/mail/message.rb#1530
  def content_type_parameters; end

  # source://mail/2.9.0/lib/mail/message.rb#1780
  def convert_to_multipart; end

  # source://mail/2.9.0/lib/mail/message.rb#620
  def date(val = T.unsafe(nil)); end

  # source://mail/2.9.0/lib/mail/message.rb#624
  def date=(val); end

  # source://mail/2.9.0/lib/mail/message.rb#1914
  def decode_body; end

  # source://mail/2.9.0/lib/mail/message.rb#1893
  def decoded; end

  # source://mail/2.9.0/lib/mail/message.rb#1211
  def default(sym, val = T.unsafe(nil)); end

  # source://mail/2.9.0/lib/mail/message.rb#250
  def deliver; end

  # source://mail/2.9.0/lib/mail/message.rb#267
  def deliver!; end

  # source://mail/2.9.0/lib/mail/message.rb#199
  def delivery_handler; end

  # source://mail/2.9.0/lib/mail/message.rb#199
  def delivery_handler=(_arg0); end

  # source://mail/2.9.0/lib/mail/message.rb#274
  def delivery_method(method = T.unsafe(nil), settings = T.unsafe(nil)); end

  # source://mail/2.9.0/lib/mail/message.rb#1550
  def delivery_status_part; end

  # source://mail/2.9.0/lib/mail/message.rb#1545
  def delivery_status_report?; end

  # source://mail/2.9.0/lib/mail/message.rb#1289
  def destinations; end

  # source://mail/2.9.0/lib/mail/message.rb#1577
  def diagnostic_code; end

  # source://mail/2.9.0/lib/mail/message.rb#1810
  def encoded; end

  # source://mail/2.9.0/lib/mail/message.rb#425
  def envelope_date; end

  # source://mail/2.9.0/lib/mail/message.rb#421
  def envelope_from; end

  # source://mail/2.9.0/lib/mail/message.rb#1573
  def error_status; end

  # source://mail/2.9.0/lib/mail/message.rb#478
  def errors; end

  # source://mail/2.9.0/lib/mail/message.rb#1930
  def filename; end

  # source://mail/2.9.0/lib/mail/message.rb#1569
  def final_recipient; end

  # source://mail/2.9.0/lib/mail/message.rb#1938
  def find_first_mime_type(mt); end

  # source://mail/2.9.0/lib/mail/message.rb#665
  def from(val = T.unsafe(nil)); end

  # source://mail/2.9.0/lib/mail/message.rb#677
  def from=(val); end

  # source://actionmailbox//lib/action_mailbox/mail_ext/addresses.rb#5
  def from_address; end

  # source://mail/2.9.0/lib/mail/message.rb#1295
  def from_addrs; end

  # source://mail/2.9.0/lib/mail/message.rb#1637
  def has_attachments?; end

  # source://mail/2.9.0/lib/mail/message.rb#1430
  def has_charset?; end

  # source://mail/2.9.0/lib/mail/message.rb#1435
  def has_content_transfer_encoding?; end

  # source://mail/2.9.0/lib/mail/message.rb#1425
  def has_content_type?; end

  # source://mail/2.9.0/lib/mail/message.rb#1415
  def has_date?; end

  # source://mail/2.9.0/lib/mail/message.rb#1409
  def has_message_id?; end

  # source://mail/2.9.0/lib/mail/message.rb#1421
  def has_mime_version?; end

  # source://mail/2.9.0/lib/mail/message.rb#450
  def header(value = T.unsafe(nil)); end

  # source://mail/2.9.0/lib/mail/message.rb#435
  def header=(value); end

  # source://mail/2.9.0/lib/mail/message.rb#1403
  def header_fields; end

  # source://mail/2.9.0/lib/mail/message.rb#455
  def headers(hash = T.unsafe(nil)); end

  # source://mail/2.9.0/lib/mail/message.rb#1642
  def html_part(&block); end

  # source://mail/2.9.0/lib/mail/message.rb#1662
  def html_part=(msg); end

  # source://mail/2.9.0/lib/mail/message.rb#681
  def in_reply_to(val = T.unsafe(nil)); end

  # source://mail/2.9.0/lib/mail/message.rb#685
  def in_reply_to=(val); end

  # source://mail/2.9.0/lib/mail/message.rb#240
  def inform_interceptors; end

  # source://mail/2.9.0/lib/mail/message.rb#236
  def inform_observers; end

  # source://mail/2.9.0/lib/mail/message.rb#1880
  def inspect; end

  # source://mail/2.9.0/lib/mail/message.rb#1884
  def inspect_structure; end

  # source://mail/2.9.0/lib/mail/message.rb#1967
  def is_marked_for_delete?; end

  # source://mail/2.9.0/lib/mail/message.rb#689
  def keywords(val = T.unsafe(nil)); end

  # source://mail/2.9.0/lib/mail/message.rb#693
  def keywords=(val); end

  # source://mail/2.9.0/lib/mail/message.rb#1520
  def main_type; end

  # source://mail/2.9.0/lib/mail/message.rb#1954
  def mark_for_delete=(value = T.unsafe(nil)); end

  # source://mail/2.9.0/lib/mail/message.rb#710
  def message_id(val = T.unsafe(nil)); end

  # source://mail/2.9.0/lib/mail/message.rb#719
  def message_id=(val); end

  # source://mail/2.9.0/lib/mail/message.rb#1384
  def method_missing(name, *args, &block); end

  # source://mail/2.9.0/lib/mail/message.rb#1499
  def mime_type; end

  # source://mail/2.9.0/lib/mail/message.rb#736
  def mime_version(val = T.unsafe(nil)); end

  # source://mail/2.9.0/lib/mail/message.rb#746
  def mime_version=(val); end

  # source://mail/2.9.0/lib/mail/message.rb#1535
  def multipart?; end

  # source://mail/2.9.0/lib/mail/message.rb#1540
  def multipart_report?; end

  # source://mail/2.9.0/lib/mail/message.rb#1729
  def part(params = T.unsafe(nil)); end

  # source://mail/2.9.0/lib/mail/message.rb#1595
  def parts; end

  # source://mail/2.9.0/lib/mail/message.rb#223
  def perform_deliveries; end

  # source://mail/2.9.0/lib/mail/message.rb#223
  def perform_deliveries=(_arg0); end

  # source://mail/2.9.0/lib/mail/message.rb#230
  def raise_delivery_errors; end

  # source://mail/2.9.0/lib/mail/message.rb#230
  def raise_delivery_errors=(_arg0); end

  # source://mail/2.9.0/lib/mail/message.rb#417
  def raw_envelope; end

  # source://mail/2.9.0/lib/mail/message.rb#404
  def raw_source; end

  # source://mail/2.9.0/lib/mail/message.rb#1906
  def read; end

  # source://mail/2.9.0/lib/mail/message.rb#1798
  def ready_to_send!; end

  # source://mail/2.9.0/lib/mail/message.rb#750
  def received(val = T.unsafe(nil)); end

  # source://mail/2.9.0/lib/mail/message.rb#758
  ...
  # source://mail/2.9.0/lib/mail/message.rb#762
  def references(val = T.unsafe(nil)); end

  # source://mail/2.9.0/lib/mail/message.rb#766
  def references=(val); end

  # source://mail/2.9.0/lib/mail/message.rb#1581
  def remote_mta; end

  # source://mail/2.9.0/lib/mail/message.rb#282
  def reply(*args, &block); end

  # source://mail/2.9.0/lib/mail/message.rb#795
  def reply_to(val = T.unsafe(nil)); end

  # source://mail/2.9.0/lib/mail/message.rb#807
  def reply_to=(val); end

  # source://mail/2.9.0/lib/mail/message.rb#836
  def resent_bcc(val = T.unsafe(nil)); end

  # source://mail/2.9.0/lib/mail/message.rb#848
  def resent_bcc=(val); end

  # source://mail/2.9.0/lib/mail/message.rb#877
  def resent_cc(val = T.unsafe(nil)); end

  # source://mail/2.9.0/lib/mail/message.rb#889
  def resent_cc=(val); end

  # source://mail/2.9.0/lib/mail/message.rb#893
  def resent_date(val = T.unsafe(nil)); end

  # source://mail/2.9.0/lib/mail/message.rb#897
  def resent_date=(val); end

  # source://mail/2.9.0/lib/mail/message.rb#926
  def resent_from(val = T.unsafe(nil)); end

  # source://mail/2.9.0/lib/mail/message.rb#938
  def resent_from=(val); end

  # source://mail/2.9.0/lib/mail/message.rb#942
  def resent_message_id(val = T.unsafe(nil)); end

  # source://mail/2.9.0/lib/mail/message.rb#946
  def resent_message_id=(val); end

  # source://mail/2.9.0/lib/mail/message.rb#965
  def resent_sender(val = T.unsafe(nil)); end

  # source://mail/2.9.0/lib/mail/message.rb#975
  def resent_sender=(val); end

  # source://mail/2.9.0/lib/mail/message.rb#1004
  def resent_to(val = T.unsafe(nil)); end

  # source://mail/2.9.0/lib/mail/message.rb#1016
  def resent_to=(val); end

  # source://mail/2.9.0/lib/mail/message.rb#1585
  def retryable?; end

  # source://mail/2.9.0/lib/mail/message.rb#1021
  def return_path(val = T.unsafe(nil)); end

  # source://mail/2.9.0/lib/mail/message.rb#1026
  def return_path=(val); end

  # source://mail/2.9.0/lib/mail/message.rb#1044
  def sender(val = T.unsafe(nil)); end

  # source://mail/2.9.0/lib/mail/message.rb#1054
  def sender=(val); end

  # source://mail/2.9.0/lib/mail/message.rb#409
  def set_envelope(val); end

  # source://mail/2.9.0/lib/mail/message.rb#1946
  def skip_deletion; end

  # source://mail/2.9.0/lib/mail/message.rb#1074
  def smtp_envelope_from(val = T.unsafe(nil)); end

  # source://mail/2.9.0/lib/mail/message.rb#1088
  def smtp_envelope_from=(val); end

  # source://mail/2.9.0/lib/mail/message.rb#1107
  def smtp_envelope_to(val = T.unsafe(nil)); end

  # source://mail/2.9.0/lib/mail/message.rb#1124
  def smtp_envelope_to=(val); end

  # source://mail/2.9.0/lib/mail/message.rb#1525
  def sub_type; end

  # source://mail/2.9.0/lib/mail/message.rb#1149
  def subject(val = T.unsafe(nil)); end

  # source://mail/2.9.0/lib/mail/message.rb#1159
  def subject=(val); end

  # source://mail/2.9.0/lib/mail/message.rb#1971
  def text?; end

  # source://mail/2.9.0/lib/mail/message.rb#1651
  def text_part(&block); end

  # source://mail/2.9.0/lib/mail/message.rb#1686
  def text_part=(msg); end

  # source://mail/2.9.0/lib/mail/message.rb#1188
  def to(val = T.unsafe(nil)); end

  # source://mail/2.9.0/lib/mail/message.rb#1200
  def to=(val); end

  # source://actionmailbox//lib/action_mailbox/mail_ext/addresses.rb#13
  def to_addresses; end

  # source://mail/2.9.0/lib/mail/message.rb#1301
  def to_addrs; end

  # source://mail/2.9.0/lib/mail/message.rb#1876
  def to_s; end

  # source://mail/2.9.0/lib/mail/message.rb#1830
  def to_yaml(opts = T.unsafe(nil)); end

  # source://mail/2.9.0/lib/mail/message.rb#628
  def transport_encoding(val = T.unsafe(nil)); end

  # source://mail/2.9.0/lib/mail/message.rb#636
  def transport_encoding=(val); end

  # source://mail/2.9.0/lib/mail/message.rb#1818
  ...
  # source://mail/2.9.0/lib/mail/message.rb#2074
  def add_boundary; end

  # source://mail/2.9.0/lib/mail/message.rb#2039
  def add_encoding_to_body; end

  # source://mail/2.9.0/lib/mail/message.rb#2069
  def add_multipart_alternate_header; end

  # source://mail/2.9.0/lib/mail/message.rb#2082
  def add_multipart_mixed_header; end

  # source://mail/2.9.0/lib/mail/message.rb#2055
  def add_required_fields; end

  # source://mail/2.9.0/lib/mail/message.rb#2063
  ...
  # source://mail/2.9.0/lib/mail/message.rb#2032
  def allowed_encodings; end

  # source://mail/2.9.0/lib/mail/message.rb#1997
  def body_lazy(value); end

  # source://mail/2.9.0/lib/mail/message.rb#2155
  def decode_body_as_text; end

  # source://mail/2.9.0/lib/mail/message.rb#2145
  def do_delivery; end

  # source://mail/2.9.0/lib/mail/message.rb#2127
  def find_attachment; end

  # source://mail/2.9.0/lib/mail/message.rb#2045
  def identify_and_set_transfer_encoding; end

  # source://mail/2.9.0/lib/mail/message.rb#2089
  def init_with_hash(hash); end

  # source://mail/2.9.0/lib/mail/message.rb#2119
  def init_with_string(string); end

  # source://mail/2.9.0/lib/mail/message.rb#391
  def initialize_copy(original); end

  # source://mail/2.9.0/lib/mail/message.rb#1986
  def parse_message; end

  # source://mail/2.9.0/lib/mail/message.rb#2012
  def process_body_raw; end

  # source://mail/2.9.0/lib/mail/message.rb#1992
  def raw_source=(value); end

  # source://mail/2.9.0/lib/mail/message.rb#2028
  def separate_parts; end

  # source://mail/2.9.0/lib/mail/message.rb#2020
  def set_envelope_header; end

  class << self
    # source://mail/2.9.0/lib/mail/message.rb#232
    def default_charset; end

    # source://mail/2.9.0/lib/mail/message.rb#233
    def default_charset=(charset); end

    # source://mail/2.9.0/lib/mail/message.rb#1872
    def from_hash(hash); end

    # source://mail/2.9.0/lib/mail/message.rb#1850
...
module Rails
  class << self
    # source://railties/8.0.3/lib/rails.rb#44
    def app_class; end

    # source://railties/8.0.3/lib/rails.rb#44
    def app_class=(_arg0); end

    # source://railties/8.0.3/lib/rails.rb#45
    def application; end

    # source://railties/8.0.3/lib/rails.rb#43
    def application=(_arg0); end

    # source://railties/8.0.3/lib/rails.rb#126
    def autoloaders; end

    # source://railties/8.0.3/lib/rails.rb#56
    ...
    # source://railties/8.0.3/lib/rails.rb#52
    def configuration; end

    # source://railties/8.0.3/lib/rails/deprecator.rb#4
    def deprecator; end

    # source://railties/8.0.3/lib/rails.rb#75
    def env; end

    # source://railties/8.0.3/lib/rails.rb#82
    def env=(environment); end

    # source://railties/8.0.3/lib/rails.rb#93
    def error; end

    # source://railties/8.0.3/lib/rails/gem_version.rb#5
    def gem_version; end

    # source://railties/8.0.3/lib/rails.rb#106
    def groups(*groups); end

    # source://railties/8.0.3/lib/rails.rb#49
    ...
    # source://railties/8.0.3/lib/rails.rb#122
    def public_path; end

    # source://railties/8.0.3/lib/rails.rb#65
    def root; end

    # source://railties/8.0.3/lib/rails/version.rb#7
    def version; end
  end
end
