...
module GeneratedPathHelpersModule
  ...
  sig { params(args: T.untyped).returns(String) }
  def edit_movie_path(*args); end

  sig { params(args: T.untyped).returns(String) }
  def edit_movie_review_path(*args); end

  sig { params(args: T.untyped).returns(String) }
  def edit_user_path(*args); end

  sig { params(args: T.untyped).returns(String) }
  def filtered_movies_path(*args); end
  ...
  sig { params(args: T.untyped).returns(String) }
  def movie_favorite_path(*args); end

  sig { params(args: T.untyped).returns(String) }
  def movie_favorites_path(*args); end

  sig { params(args: T.untyped).returns(String) }
  def movie_path(*args); end

  sig { params(args: T.untyped).returns(String) }
  def movie_review_path(*args); end

  sig { params(args: T.untyped).returns(String) }
  def movie_reviews_path(*args); end

  sig { params(args: T.untyped).returns(String) }
  def movies_path(*args); end

  sig { params(args: T.untyped).returns(String) }
  def new_genre_path(*args); end

  sig { params(args: T.untyped).returns(String) }
  def new_movie_path(*args); end

  sig { params(args: T.untyped).returns(String) }
  def new_movie_review_path(*args); end
