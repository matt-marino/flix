...
class Rails::Application < ::Rails::Engine
  # source://railties/8.0.3/lib/rails/application.rb#109
  ...
  # source://railties/8.0.3/lib/rails/application.rb#102
  def autoloaders; end

  # source://railties/8.0.3/lib/rails/engine.rb#516
  def build_middleware_stack; end

  # source://railties/8.0.3/lib/rails/application.rb#455
  def config; end

  # source://railties/8.0.3/lib/rails/application.rb#459
  def config=(_arg0); end

  # source://railties/8.0.3/lib/rails/application.rb#292
  def config_for(name, env: T.unsafe(nil)); end

  # source://railties/8.0.3/lib/rails/application.rb#375
  def console(&blk); end

  # source://railties/8.0.3/lib/rails/application.rb#499
  def credentials; end

  # source://railties/8.0.3/lib/rails/application.rb#460
  def credentials=(_arg0); end

  # source://railties/8.0.3/lib/rails/application.rb#104
  def default_url_options(*_arg0, **_arg1, &_arg2); end

  # source://railties/8.0.3/lib/rails/application.rb#104
  def default_url_options=(arg); end

  # source://railties/8.0.3/lib/rails/application.rb#248
  def deprecators; end

  # source://railties/8.0.3/lib/rails/application.rb#557
  def eager_load!; end

  # source://railties/8.0.3/lib/rails/application.rb#518
  def encrypted(path, key_path: T.unsafe(nil), env_key: T.unsafe(nil)); end

  # source://railties/8.0.3/lib/rails/application.rb#321
  def env_config; end

  # source://railties/8.0.3/lib/rails/application.rb#102
  def executor; end

  # source://railties/8.0.3/lib/rails/application.rb#381
  def generators(&blk); end

  # source://railties/8.0.3/lib/rails/application.rb#531
  def helpers_paths; end

  # source://importmap-rails/2.2.2/lib/importmap/engine.rb#4
  def importmap; end

  # source://importmap-rails/2.2.2/lib/importmap/engine.rb#4
  def importmap=(_arg0); end

  # source://railties/8.0.3/lib/rails/application.rb#442
  def initialize!(group = T.unsafe(nil)); end

  # source://railties/8.0.3/lib/rails/application.rb#134
  def initialized?; end

  # source://railties/8.0.3/lib/rails/application.rb#363
  def initializer(name, opts = T.unsafe(nil), &block); end

  # source://railties/8.0.3/lib/rails/application.rb#449
  def initializers; end

  # source://railties/8.0.3/lib/rails/application.rb#392
  def isolate_namespace(mod); end

  # source://railties/8.0.3/lib/rails/application.rb#176
  def key_generator(secret_key_base = T.unsafe(nil)); end

  # source://railties/8.0.3/lib/rails/application.rb#551
  def load_generators(app = T.unsafe(nil)); end

  # source://railties/8.0.3/lib/rails/application.rb#240
  def message_verifier(verifier_name); end

  # source://railties/8.0.3/lib/rails/application.rb#212
  def message_verifiers; end

  # source://railties/8.0.3/lib/rails/application.rb#547
  def migration_railties; end

  # source://railties/8.0.3/lib/rails/application.rb#141
  def name; end
  ...
  # source://railties/8.0.3/lib/rails/application.rb#356
  def rake_tasks(&block); end

  # source://railties/8.0.3/lib/rails/application.rb#160
  def reload_routes!; end

  # source://railties/8.0.3/lib/rails/application.rb#168
  ...
  # source://railties/8.0.3/lib/rails/application.rb#418
  def require_environment!; end

  # source://railties/8.0.3/lib/rails/application.rb#423
  def routes_reloader; end

  # source://railties/8.0.3/lib/rails/application.rb#145
  def run_load_hooks!; end

  # source://railties/8.0.3/lib/rails/application.rb#369
  def runner(&blk); end

  # source://railties/8.0.3/lib/rails/application.rb#100
  def sandbox; end
  ...
  # source://railties/8.0.3/lib/rails/application.rb#481
  def secret_key_base; end

  # source://railties/8.0.3/lib/rails/application.rb#387
  def server(&blk); end

  # source://railties/8.0.3/lib/rails/application.rb#527
  def to_app; end

  # source://railties/8.0.3/lib/rails/application.rb#430
  def watchable_args; end

  protected

  # source://railties/8.0.3/lib/rails/application.rb#630
  def default_middleware_stack; end

  # source://railties/8.0.3/lib/rails/application.rb#635
  def ensure_generator_templates_added; end

  # source://railties/8.0.3/lib/rails/application.rb#596
  def ordered_railties; end

  # source://railties/8.0.3/lib/rails/application.rb#618
  def railties_initializers(current); end

  # source://railties/8.0.3/lib/rails/application.rb#585
  def run_console_blocks(app); end

  # source://railties/8.0.3/lib/rails/application.rb#575
  def run_generators_blocks(app); end

  # source://railties/8.0.3/lib/rails/application.rb#580
  def run_runner_blocks(app); end

  # source://railties/8.0.3/lib/rails/application.rb#590
  def run_server_blocks(app); end

  # source://railties/8.0.3/lib/rails/application.rb#564
  def run_tasks_blocks(app); end

  private

  # source://railties/8.0.3/lib/rails/application.rb#648
  def build_middleware; end

  # source://railties/8.0.3/lib/rails/application.rb#641
  def build_request(env); end

  # source://railties/8.0.3/lib/rails/application.rb#652
  def coerce_same_site_protection(protection); end

  # source://railties/8.0.3/lib/rails/application.rb#656
  def filter_parameters; end

  class << self
    # source://railties/8.0.3/lib/rails/application.rb#411
    def add_lib_to_load_path!(root); end

    # source://railties/8.0.3/lib/rails/application.rb#84
    def create(initial_variable_values = T.unsafe(nil), &block); end

    # source://railties/8.0.3/lib/rails/application.rb#88
    def find_root(from); end

    # source://railties/8.0.3/lib/rails/application.rb#71
    def inherited(base); end

    # source://railties/8.0.3/lib/rails/application.rb#80
    def instance; end
...
class Rails::Application::Configuration < ::Rails::Engine::Configuration
  # source://railties/8.0.3/lib/rails/application/configuration.rb#30
  def initialize(*_arg0); end

  # source://railties/8.0.3/lib/rails/application/configuration.rb#14
  ...
  # source://railties/8.0.3/lib/rails/application/configuration.rb#563
  def annotations; end

  # source://railties/8.0.3/lib/rails/application/configuration.rb#28
  def api_only; end

  # source://railties/8.0.3/lib/rails/application/configuration.rb#376
  ...
  # source://railties/8.0.3/lib/rails/application/configuration.rb#471
  def autoload_lib(ignore:); end

  # source://railties/8.0.3/lib/rails/application/configuration.rb#483
  ...
  # source://railties/8.0.3/lib/rails/application/configuration.rb#388
  ...
  # source://railties/8.0.3/lib/rails/application/configuration.rb#495
  def colorize_logging; end

  # source://railties/8.0.3/lib/rails/application/configuration.rb#499
  ...
  # source://railties/8.0.3/lib/rails/application/configuration.rb#568
  ...
  # source://railties/8.0.3/lib/rails/application/configuration.rb#434
  def database_configuration; end

  # source://railties/8.0.3/lib/rails/application/configuration.rb#390
  def debug_exception_response_format; end

  # source://railties/8.0.3/lib/rails/application/configuration.rb#394
  def debug_exception_response_format=(_arg0); end

  # source://railties/8.0.3/lib/rails/application/configuration.rb#585
  ...
  # source://railties/8.0.3/lib/rails/application/configuration.rb#360
  def enable_reloading; end

  # source://railties/8.0.3/lib/rails/application/configuration.rb#364
  def enable_reloading=(value); end

  # source://railties/8.0.3/lib/rails/application/configuration.rb#28
  def encoding; end

  # source://railties/8.0.3/lib/rails/application/configuration.rb#368
  ...
  # source://railties/8.0.3/lib/rails/application/configuration.rb#597
  def inspect; end

  # source://railties/8.0.3/lib/rails/application/configuration.rb#416
  def load_database_yaml; end

  # source://railties/8.0.3/lib/rails/application/configuration.rb#92
  ...
  # source://railties/8.0.3/lib/rails/application/configuration.rb#383
  ...
  # source://railties/8.0.3/lib/rails/application/configuration.rb#396
  def paths; end

  # source://railties/8.0.3/lib/rails/application/configuration.rb#577
  ...
  # source://railties/8.0.3/lib/rails/application/configuration.rb#356
  ...
  # source://railties/8.0.3/lib/rails/application/configuration.rb#504
  def secret_key_base; end

  # source://railties/8.0.3/lib/rails/application/configuration.rb#516
  ...
  # source://railties/8.0.3/lib/rails/application/configuration.rb#543
  def session_store(new_session_store = T.unsafe(nil), **options); end

  # source://railties/8.0.3/lib/rails/application/configuration.rb#559
  ...
  # source://railties/8.0.3/lib/rails/application/configuration.rb#624
  def credentials_defaults; end

  # source://railties/8.0.3/lib/rails/application/configuration.rb#634
