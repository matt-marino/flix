...
Gem::Specification.new do |s|
  ...
  s.add_runtime_dependency(%q<bundler>.freeze, [">= 2.2.25".freeze])
  s.add_runtime_dependency(%q<netrc>.freeze, [">= 0.11.0".freeze])
  s.add_runtime_dependency(%q<parallel>.freeze, [">= 1.21.0".freeze])
  s.add_runtime_dependency(%q<rbi>.freeze, ["~> 0.2".freeze])
  s.add_runtime_dependency(%q<sorbet-static-and-runtime>.freeze, [">= 0.5.11087".freeze])
  s.add_runtime_dependency(%q<spoom>.freeze, [">= 1.2.0".freeze])
  s.add_runtime_dependency(%q<thor>.freeze, [">= 1.2.0".freeze])
  s.add_runtime_dependency(%q<yard-sorbet>.freeze, [">= 0".freeze])
end
